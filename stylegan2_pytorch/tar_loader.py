...
class TarDataset(Dataset):
  ...
  Attributes:
    members_by_name (dict): Membaers (files and folders) found in the Tar archive,
  ...
  """
  def __init__(self, archive, transform=to_tensor, labeled:bool=False, extensions=('.png', '.jpg', '.jpeg'),
